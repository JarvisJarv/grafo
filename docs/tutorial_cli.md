...
| `--layout {spring,circular,kamada_kawai}` | Escolhe o layout do desenho. `spring` é o padrão. | `python -m src.main exemplos/usuario_filme_equilibrado.txt --plot --layout circular` |
