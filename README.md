...
2. Rode o verificador com um arquivo de exemplo: `python -m src.main exemplos/bipartido.txt --plot` (ou, se preferir executar diretamente o arquivo, `python src/main.py exemplos/bipartido.txt --plot`).
3. Para exportar uma animação: `python -m src.main exemplos/nao_bipartido.txt --animar --exportar-animacao docs/imagens/biparticao.gif`.
